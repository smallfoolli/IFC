...
from models.Teacher_Class import TeacherNet17 as TeacherModel
...
parser.add_argument('--LR', type=float, default=[0.00010], help='The learning rate')
...
def teacher_main(args, train_loader, test_loader, LR):
    ...
    # torch.save(model, args.Model_save_path + '/Trained teacher3 model on data2 cross scenario')
...
# df_result.to_csv(args.Result_save_path + 'Teacher3 results_LR_optim BSsearch on data3 cross person.csv', index=False, sep=',')
# df_result.to_csv(args.Result_save_path + 'Teacher3 results_LR_optim BS_optim on data2 cross scenerio StructureO_3FC_5ConvCvar.csv', index=False, sep=',')

# df_result.to_csv(args.Result_save_path + 'Teacher3 results_LR_optim BS_optim on data3 cross person Structure_4C_2FcVar.csv', index=False, sep=',')

df_result.to_csv(args.Result_save_path + 'Teacher3 results_LR_optim BS_optim on data2 cross scenario Structure_4C_2FcVar.csv', index=False, sep=',')
