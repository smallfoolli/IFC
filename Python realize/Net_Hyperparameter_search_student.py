...
def teacher_main(args, train_loader, test_loader, LR):
    ...
    # torch.save(model, args.Model_save_path + '/Trained student8 model without Infor in data2 Cross scenario')
    # torch.save(model, args.Model_save_path + '/Trained student9 model without Infor in data2 Cross scenario')
    torch.save(model, args.Model_save_path + '/Trained student9 model without Infor lr0004 in data3 Cross person')
...
# df_result.to_csv(args.Result_save_path + 'Teacher2 results_LR_Batch vari FineSearch on data2 cross scenerio.csv', index=False, sep=',')
#
# df_result.to_csv(args.Result_save_path + 'Teacher results_LR_Batchsize on data1 normal.csv', index=False, sep=',')
#画出训练测试曲线
# df_result.to_csv(args.Result_save_path + 'Teacher3 results_LR_optim search on data2 cross scenerio.csv', index=False, sep=',')
# df_result.to_csv(args.Result_save_path + 'Student8 results_LRVar_optim search on data3 cross person.csv', index=False, sep=',')
# df_result.to_csv(args.Result_save_path + 'Student8 results_LR_optim BSsearch on data3 cross person.csv', index=False, sep=',')

# df_result.to_csv(args.Result_save_path + 'Student9 results_LR_optim BSsearch on data2 cross scenerio.csv', index=False, sep=',')

# df_result.to_csv(args.Result_save_path + 'Student9 results_LR_optim BSsearch on data3 cross person.csv', index=False, sep=',')
df_result.to_csv(args.Result_save_path + 'Student9 results_LR0004 without Infor on data3 cross person.csv', index=False, sep=',')
