...
parser.add_argument('--Temperature', type=float, default=[1.0, 2.0, 5.0, 7.0, 10.0, 20.0, 50.0], help='The Temperature')
#parser.add_argument('--Alpha', type=float, default=[0.3], help='The Alpha')
...
def KD_student_main(args, train_loader, test_loader):
    ...
    #torch.save(model, args.Model_save_path + '/Trained KD student2 model on datasetp2')
...
print(df_result)
df_result.to_csv(args.Result_save_path + 'Student2 with KD results on datasetp20007AVTV.csv', index=False, sep=',')
