...
parser.add_argument('--LR', type=float, default=[0.00006], help='The learning rate')
...
def student_main(args, train_loader, test_loader, LR):
    ...
    # torch.save(model, args.Model_save_path + '/Trained student6 model on datasets115 LR0.0012 BS16')
    torch.save(model, args.Model_save_path + '/Trained student8 model on dataset24K5 LR0.00006 BS32')
...
print(df_result)
#df_result.to_csv(args.Result_save_path + 'Student4 results_LR_Batchsize on dataset_s115.csv', index=False, sep=',')
